                ...
                <div class="card-body"><h4 class="mt-0 header-title">Promo Details</h4>
                    ...
                    <form method="post" action="/admin/promo/store" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="promo_code" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="discount_rate" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="max_discount" required/>
                            </div>
                        </div>
