                ...
                <div class="card-body"><h4 class="mt-0 header-title">Slider Details</h4>
                    ...
                    <form method="post" action="/admin/slider/update" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="slider_name" value="{{$slider->slider_name}}">
                                <input class="form-control" type="hidden" name="_token" value="{{csrf_token()}}">
                                <input class="form-control" type="hidden" name="slider_id" value="{{$slider->slider_id}}">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Slider Image <span style="color: red">870*422PX</span></label>
                            <div class="col-sm-10">
